...
/** ********************静态页面跳转管理地址--begin--**************************** */
// 首页跳转地址
config.index = config.jumpServer;
//馆藏量跳转地址
...
//按照id获取rfid盘点数据
config.getRfidById = config.serverPath+"/rfidInty/getRfidById";
//轮询获取温度展示首页
config.getHumForAlarm = config.interfaceServer+"alarm/getHumForAlarm";
/** ********************动态数据异步加载管理地址--end----************************* */
