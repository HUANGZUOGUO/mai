			...
			<div class="archives" id="he">
				<h2>
				 <form  method="get" action="">	
                  ...
                  <input id="nyr" class="Wdate my97" value="${sessionScope.time}" onFocus="WdatePicker({lang:'zh-cn',readOnly:true,onpicked:function(){console.log($('#nyr').val());showInfo();},maxDate:'%y-%M-%d'})" />盘点清单
	              </form>
                </h2>
                           ...
                           <table  id="extra">
								...
								<tbody>
									<tr>
										...
										<td>在库</td>
										<td>否</td>
										<td><time>2017-11-14 10:55</time></td>
									</tr>
									<tr>
										<td>ABCD－00001</td>
										<td>关于房土建设相关文件</td>
